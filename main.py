...
def main():
    ...
    accuracy, balanced_acc, roc_auc, classifi_rep = train_logistic_regression(feature_engineering=True, n_iterations=300, batch_size=512)

    # print(f"Best Model: {best_model:.4f}")
